...
<template>
  <header class="">
    <section class="bg-gray-100">
      <div class="justify-between flex px-28 py-2 ">
      ...
      <div class="py-14">
        <div class="flex flex-row justify-center text-center items-center">
          ...
          <div class="flex border w-6/12  bg-gray-100">
            ...
            <div class="border border-gray- my-2 mx-2 "></div>
          ...
          <div class="flex justify-between ms-8 gap-5">
            <div class="flex flex-row  hover:text-amber-800  cursor-pointer ">
              <div
                ...
                <svg class="flex flex-row overflow-hidden fill-current mx-auto my-auto hover:fill-white "
                  xmlns="http://www.w3.org/2000/svg" height="25px" viewBox="0 -960 960 960" width="30px" fill="#5f6368">
                  <path
              ...
              <div class="text-sm ms-4">
                <p class=" text-left mt-2">CALL</p>
                <p class="">657-779-342</p>
              </div>

            </div>
            <div class="flex flex-row hover:text-amber-800  active:text-amber-800 active:font-bold cursor-pointer">
              <div
                class=" flex border border-gray-100 rounded-full py-2 text-center justify-center  h-12 w-12 hover:text-black hover:bg-accent ">
                <svg class="fill-current hover:fill-white" xmlns="http://www.w3.org/2000/svg" height="25px"
