      ...
      <div class="mx-auto  px-4 sm:px-6 lg:px-8 container">
        ...
        <div class=" flex max-sm:max-w-sm max-sm:mx-auto">
          <div class="col-span-full mb-10 lg:col-span-2 lg:mb-0 border-r border-gray-700" data-aos="fade-up"
            ...
            <a href="javascript:;"
              class="py-2.5 px-5 h-9 block w-fit bg-[#E01520] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-red-500 lg:mx-0">
              Contact us
            </a>
          </div>
          <!--End Col-->
          ...
          <div class="text-center px-16 block_newsletter" data-aos="fade-up" data-aos-anchor-placement="top-bottom"
            ...
            <p class="lg:max-w-xs text-sm  transition-all duration-500 text-gray-600">Vous pouvez
              vous désinscrire à tout moment. Vous
              trouverez pour cela nos informations
              de contact dans les
              conditions d'utilisation du site.</p>
            <form class="mt-4">
...
.block_newsletter .btn.btn-primary {
  ...
  width: 30px;
  padding: 0;
  background: #E01520 url(data:image/png;base64,) no-repeat center 8px !important;
  margin: 4px;
  position: absolute;
  right: 0;
  top: 0
