...
import harlequin from "@/assets/categories/harlequin.jpg"
...
<template>
  <section class="w-full bg-brand-lighter-gray">
    <div class="w-full px-6 md:px-20 xl:px-40 py-24 max-w-[1440px] mx-auto">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        <article v-for="article in articles" :key="article.id"
          ...
          <img :src="article.cover" class="w-full h-[200px] object-cover" alt="cover" />
          <div class="p-6">
            <h4
              class="text-body text-brand-dark-blue leading-snug font-heading mb-2 transition-all duration-200 ease hover:text-red-600 uppercase">
